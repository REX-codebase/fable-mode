---
{
  ...
  "antibodies": [
    {
      ...
      "domain": "research",
      "trigger_condition": "Emitting paper citations, authors, or benchmark numbers without verifying exact DOI or primary archive existence",
    ...
    },
    {
      ...
      "domain": "research",
      "trigger_condition": "Reporting throughput or latency metrics under artificial isolated synthetic conditions without reporting tail percentiles (p99/p99.9)",
    ...
    },
    {
      ...
      "domain": "research",
      "trigger_condition": "Conditioning on a common effect (collider) when analyzing distributed system failure root causes",
  ...
  "specialized_heuristics": [
    ...
    "Epistemic State Partitioning: Explicitly tag propositions as [PROVEN] (receipt backed), [HYPOTHESIS] (untested inference), or [UNKNOWN] (unmeasured parameter).",
    "Causal vs Correlative Discipline: Construct a Pearlian Directed Acyclic Graph (DAG) before claiming intervention efficacy; rule out confounding and collider bias."
  ],
...
| `zero_cost_scrapers` | `0.7000` | 🟢 Strong |
