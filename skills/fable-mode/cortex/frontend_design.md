...
synaptic_weights:
  ...
  render_vector: 0.92
  spring_motion_physics: 0.90
  fluid_typography: 0.90
antibodies:
- antibody_id: ab_design_purple_glow_slop
  ...
  prescribed_defense: Eliminate generic purple blobs. Use a single curated OKLCH accent colorway (Cold Luxury, Cobalt, Nordic Pine, Obsidian Monolith) anchored on a neutral base with inverse-square volumetric lighting.
  severity: CRITICAL
