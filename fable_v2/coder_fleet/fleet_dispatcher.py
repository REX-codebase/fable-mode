...
class CoderFleetDispatcher:
    ...
    def __init__(
        ...
        self._actions: dict[str, Callable[..., Any]] = {
            ...
            "cortical_define_lobe": self.plasticity_engine._define_cortical_lobe_from_trusted_caller,
            ...
            "cortical_recall_context": self.plasticity_engine._recall_cortical_context_from_trusted_caller,
